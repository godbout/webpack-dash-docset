...
class EntriesTest extends TestCase
{
    ...
    /** @test */
    public function the_dash_docset_has_some_entries_of_type_Option()
    {
        Config::set(
            'database.connections.sqlite.database',
            "storage/{$this->docset->databaseFile()}"
        ...
        $this->assertNotEquals(
            0,
            DB::table('searchIndex')->where('type', 'Option')->count()
        );
    }
    ...
    public function the_dash_docset_has_some_entries_of_type_Plugin()
    {
        ...
        $this->assertNotEquals(
            0,
            DB::table('searchIndex')->where('type', 'Plugin')->count()
        );
    }
